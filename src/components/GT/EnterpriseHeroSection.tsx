  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center relative z-10">
          ...
          >
            ...
            {!isPlaying && (
              <>
                ...
                <div className="absolute top-3.5 left-3.5 z-20 bg-[#2563EB] text-white px-3 py-1 text-xs font-semibold rounded-full shadow-md flex items-center gap-1.5 backdrop-blur-md">
                  <Sparkles className="w-3.5 h-3.5 text-white" />
                  <span>{currentVideo.badgeTag}</span>
                </div>

                {/* Center Play Button */}
                <div className="absolute inset-0 m-auto z-20 w-[68px] h-[68px] rounded-full bg-white text-[#2563EB] flex items-center justify-center shadow-[0_10px_30px_rgba(15,23,42,0.3)] transition-all duration-300 group-hover:scale-108 group-hover:shadow-[0_14px_40px_rgba(37,99,235,0.4)]">
        ...
        {/* Right Section: Compact Non-Stretched Featured Videos Card (lg:col-span-5) */}
        <div className="lg:col-span-5 flex items-center justify-center lg:justify-end">
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-md p-5 space-y-4 w-full max-w-[420px] transition-all duration-300 hover:shadow-lg">
            {/* Card Top Title Row */}
            <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
              ...
              <span className="text-[10px] font-mono text-blue-700 bg-blue-50 px-2.5 py-0.5 rounded-full font-bold border border-blue-200">
                ...
                return (
                  <button
                    ...
                    className={`h-[46px] rounded-xl font-bold text-xs flex items-center justify-center gap-2 px-3 transition-all duration-200 select-none cursor-pointer ${isActive
                        ? 'bg-gradient-to-r from-[#2563EB] to-[#3B82F6] text-white shadow-md shadow-blue-600/25 border-transparent -translate-y-0.5'
                        : 'bg-slate-50 hover:bg-blue-50/70 border border-slate-200 text-[#0F172A] hover:-translate-y-0.5'
                      }`}
                  >
